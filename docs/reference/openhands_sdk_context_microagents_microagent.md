...
##### load(path: Union[str, pathlib.Path], microagent_dir: pathlib.Path | None = None, file_content: str | None = None) -> 'BaseMicroagent'
...
##### match_trigger(self, message: str) -> str | None
...
##### extract_variables(self, content: str) -> list[str]
...
### load_microagents_from_dir(microagent_dir: str | pathlib.Path) -> tuple[dict[str, openhands.sdk.context.microagents.microagent.RepoMicroagent], dict[str, openhands.sdk.context.microagents.microagent.KnowledgeMicroagent]]
