...
##### to_llm_dict(self) -> dict[str, str | dict[str, str]] | list[dict[str, str | dict[str, str]]]
...
##### from_litellm_message(message: litellm.types.utils.Message) -> 'Message'
...
##### to_llm_dict(self) -> dict[str, typing.Any]
...
##### to_llm_dict(self) -> dict[str, str | dict[str, str]]

Convert to LLM API format.

## Functions

### content_to_str(contents: list[openhands.sdk.llm.message.TextContent | openhands.sdk.llm.message.ImageContent]) -> list[str]
