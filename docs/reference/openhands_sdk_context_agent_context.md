...
##### get_user_message_suffix(self, user_message: openhands.sdk.llm.message.Message, skip_microagent_names: list[str]) -> tuple[openhands.sdk.llm.message.TextContent, list[str]] | None
