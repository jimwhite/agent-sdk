...
### get_edit_groups(old_content: str, new_content: str, n_context_lines: int = 2) -> list[openhands.tools.str_replace_editor.utils.diff.EditGroup]
...
### visualize_diff(path: str, old_content: str | None, new_content: str | None, n_context_lines: int = 2, change_applied: bool = True) -> rich.text.Text
