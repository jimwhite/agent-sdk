...
##### completion(self, messages: list[dict[str, typing.Any]] | list[openhands.sdk.llm.message.Message], tools: list[litellm.types.llms.openai.ChatCompletionToolParam] | None = None, return_metrics: bool = False, **kwargs) -> litellm.types.utils.ModelResponse
...
##### format_messages_for_llm(self, messages: list[openhands.sdk.llm.message.Message]) -> list[dict]
...
##### is_function_calling_active(self) -> bool
