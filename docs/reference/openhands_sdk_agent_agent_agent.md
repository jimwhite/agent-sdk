...
##### init_state(self, state: openhands.sdk.conversation.state.ConversationState, on_event: Callable[[Annotated[openhands.sdk.event.base.EventBase, DiscriminatedUnion[EventBase]]], NoneType]) -> None
...
##### step(self, state: openhands.sdk.conversation.state.ConversationState, on_event: Callable[[Annotated[openhands.sdk.event.base.EventBase, DiscriminatedUnion[EventBase]]], NoneType]) -> None
