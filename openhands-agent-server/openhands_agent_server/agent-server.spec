...
a = Analysis(
    ...
    datas=[
        ...
        *collect_data_files('openhands_sdk.agent', includes=['prompts/*.j2']),
        *collect_data_files('openhands_sdk.context.condenser', includes=['prompts/*.j2']),
        *collect_data_files('openhands_sdk.context.prompts', includes=['templates/*.j2']),
        # Include package metadata for importlib.metadata
        *copy_metadata('fastmcp'),
    ],
    hiddenimports=[
        *collect_submodules('openhands_sdk'),
        *collect_submodules('openhands_tools'),
        *collect_submodules('openhands_agent_server'),
