...
def test_real_create_mcp_tools_dict_config():
    ...
    input_schema = tools[0].input_schema.to_mcp_schema()
    ...
    # Note: security_risk field was automatically added in the old ActionBase system
    # but is not part of the new schema-based system
