...
class MockAsyncUtilsEvent(EventBase):
...
def test_async_callback_wrapper_multiple_events():
    ...
    async def run_test():
        ...
        events = [MockAsyncUtilsEvent() for _ in range(3)]
...
def test_async_callback_wrapper_concurrent_execution():
    ...
    async def run_test():
        ...
        events = [MockAsyncUtilsEvent() for _ in range(5)]
...
def test_async_callback_wrapper_performance():
    ...
    async def run_test():
        ...
        events = [MockAsyncUtilsEvent() for _ in range(100)]
