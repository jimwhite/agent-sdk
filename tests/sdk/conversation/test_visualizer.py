...
class MockVisualizerAction(ActionBase):
...
class CustomVisualizerAction(ActionBase):
...
def test_action_base_visualize():
    ...
    action = MockVisualizerAction(command="echo hello", working_dir="/home")
    ...
    assert "MockVisualizerAction" in text_content
...
def test_custom_action_visualize():
    ...
    action = CustomVisualizerAction(task_list=tasks)
...
def test_action_event_visualize():
    ...
    action = MockVisualizerAction(command="ls -la", working_dir="/tmp")
...
def test_observation_event_visualize():
    ...
    class MockVisualizerObservation(ObservationBase):
    ...
    observation = MockVisualizerObservation(
...
def test_visualizer_event_panel_creation():
    ...
    action = MockVisualizerAction(command="test")
