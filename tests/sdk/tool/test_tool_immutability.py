...
class MockToolImmutabilityAction(ActionBase):
...
class MockToolImmutabilityObservation(ObservationBase):
...
class TestToolImmutability:
    ...
    def test_tool_is_frozen(self):
        ...
        tool = Tool(
            ...
            action_type=MockToolImmutabilityAction,
            observation_type=MockToolImmutabilityObservation,
        )
    ...
    def test_tool_set_executor_returns_new_instance(self):
        ...
        class NewExecutor(
            ToolExecutor[MockToolImmutabilityAction, MockToolImmutabilityObservation]
        ):
            def __call__(
                self, action: MockToolImmutabilityAction
            ) -> MockToolImmutabilityObservation:
                return MockToolImmutabilityObservation(result="new_result")
    ...
    def test_tool_constructor_parameter_validation(self):
        ...
        assert tool.action_type == MockToolImmutabilityAction
        assert tool.observation_type == MockToolImmutabilityObservation
