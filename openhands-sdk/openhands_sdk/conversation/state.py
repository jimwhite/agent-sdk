...
from openhands_sdk.conversation.persistence_const import BASE_STATE, EVENTS_DIR
from openhands_sdk.conversation.secrets_manager import SecretsManager
from openhands_sdk.conversation.types import ConversationCallbackType, ConversationID
from openhands_sdk.event import ActionEvent, ObservationEvent, UserRejectObservation
from openhands_sdk.event.base import Event
from openhands_sdk.io import FileStore, InMemoryFileStore, LocalFileStore
        ...
        if old is _sentinel or old != value:
            ...
            if callback is not None and old is not _sentinel:
                try:
                    ...
                    from openhands_sdk.event.conversation_state import (
