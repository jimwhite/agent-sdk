...
def register_planning_tools() -> None:
    ...
    from openhands_tools.glob import GlobTool
    from openhands_tools.grep import GrepTool
    from openhands_tools.planning_file_editor import PlanningFileEditorTool
