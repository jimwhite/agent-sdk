# openhands-client
A client library for accessing OpenHands Agent Server

## Usage
First, create a client:

```python
from openhands_client import Client
...
```python
from openhands_client import AuthenticatedClient
...
```python
from openhands_client.models import MyDataModel
from openhands_client.api.my_tag import get_my_data_model
from openhands_client.types import Response
...
1. Any endpoint which did not have a tag will be in `openhands_client.api.default`
