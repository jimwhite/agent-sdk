"""Remote API-based runtime image builder.

Adapted from OpenHands V0 openhands/runtime/builder/remote.py
"""
...
from openhands.workspace.remote_api.utils.shutdown_listener import (
    should_continue,
