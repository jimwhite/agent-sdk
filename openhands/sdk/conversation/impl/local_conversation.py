    ...
    def __init__(
        ...
        **_: object,
        ...
        Args:
            ...
            workspace: Workspace instance for agent operations and tool execution
        ...
        assert (
            ...
            and workspace.get_workspace_type() == "local"
        ), "workspace must be a local workspace instance"
