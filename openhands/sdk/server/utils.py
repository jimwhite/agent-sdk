"""
Utility functions for agent servers.
"""
...
def get_agent_server_build_instructions() -> str:
    """
    Get instructions for building agent server images for RemoteAgentServer.

    Returns:
        A string with detailed instructions
    """
    return """
Building Agent Server Images for RemoteAgentServer
=================================================

The RemoteAgentServer requires a container image that has the OpenHands
agent server pre-installed. Here are several ways to create such an image:

Method 1: Use the utility function
---------------------------------
from openhands.sdk.server import build_and_push_agent_server_image
...
Method 2: Build with DockerAgentServer and push manually
--------------------------------------------------------
from openhands.sdk.server import build_agent_server_image
import subprocess
...
Using the image with RemoteAgentServer
--------------------------------------
