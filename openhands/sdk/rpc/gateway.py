...
class RuntimeGateway:
    ...
    def sync_routes(self) -> None:
        schema = self.transport.request("GET", "/rpc/schema")
        self.routes.clear()
        for r in schema:
    ...
    def _resolve_route(self, class_name: str, method_name: str) -> tuple[str, str]:
        return self.routes.get((class_name, method_name), ("POST", "/rpc"))
