...
def create_app() -> FastAPI:
    ...
    Raises:
        ValueError: If OPENHANDS_MASTER_KEY environment variable is not set
    """
    # Validate master key
    ...
    async def get_stats() -> Dict[str, Any]:
        ...
        """
        from .routers.conversations import get_conversation_manager
        ...
        openapi_schema["tags"] = [
            {
                "name": "conversations",
                "description": (
                    "Conversation management with 1-1 mapping to "
