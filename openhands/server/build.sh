#!/bin/bash
#
# Shell script wrapper for building OpenHands Server executable.
#
# This script provides a simple interface to build the OpenHands Server
# using PyInstaller with uv package management.
#

set -e  # Exit on any error

echo "🚀 OpenHands Server Build Script"
echo "================================="
