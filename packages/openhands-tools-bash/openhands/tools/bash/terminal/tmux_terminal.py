...
from openhands.tools.bash.constants import HISTORY_LIMIT
from openhands.tools.bash.metadata import CmdOutputMetadata
from openhands.tools.bash.terminal import TerminalInterface
...
class TmuxTerminal(TerminalInterface):
    ...
    def is_running(self) -> bool:
        ...
        try:
            ...
            from openhands.tools.bash.constants import CMD_OUTPUT_PS1_END
