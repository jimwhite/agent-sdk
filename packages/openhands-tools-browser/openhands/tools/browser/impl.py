...
from openhands.tools.browser.server import CustomBrowserUseServer
...
class BrowserToolExecutor(ToolExecutor):
    ...
    async def _execute_action(self, action):
        ...
        from openhands.tools.browser.definition import (
            BrowserClickAction,
    ...
    async def get_state(self, include_screenshot: bool = False):
        ...
        from openhands.tools.browser.definition import BrowserObservation
