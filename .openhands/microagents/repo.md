...
- You should put unit tests in the corresponding test folder. For example, to test `openhands-sdk/openhands_sdk/tool/tool.py`, you should put tests under `tests/tool/test_tool.py`.
