...
- You should put unit tests in the corresponding test folder. For example, to test `openhands_sdk.tool/tool.py`, you should put tests under `openhands_sdk.tests/tool/test_tool.py`.
